import { AppService, createAppSchema, updateAppSchema, } from "../services/app.service";
...
export default async function appRoutes(fastify) {
    ...
    fastify.put("/:appId/env", {
        ...
        try {
            ...
            const app = await appService.updateEnvVars(appId, request.user.id, envVars);
            return {
